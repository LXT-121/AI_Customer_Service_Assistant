    ...
    <div class="sidebar" :class="{ 'sidebar-collapsed': isSidebarCollapsed }">
      <div class="sidebar-header">
        <div class="logo-wrapper">
          <span class="logo-text"><span class="logo-highlight">Knowledge Desk</span></span>
      ...
      <div class="user-section">
        <!-- 服务演示入口 -->
        <div class="service-entry-link" @click="goToServiceDemo">
          <div class="service-entry-icon">
          ...
          <span class="service-entry-text">服务演示</span>
          <div class="service-entry-badge">Demo</div>
        </div>
      ...
      <div class="chat-content">
        ...
        <div v-if="!messages.length && !uploadedFile" class="initial-state">
          <div class="welcome-message">
            <h2>我是 Knowledge Desk，很高兴见到你。</h2>
            <p>我可以帮助你处理知识问答、资料检索、文件解读与服务流程说明。</p>
          </div>
          <div class="chat-input">
            <div class="input-wrapper">
              <input
                ...
                type="text"
                placeholder="给 Knowledge Desk 发送消息"
              />
...
const popupMessages = ref<PopupMessage[]>([
  { role: 'assistant', content: '您好！我是知识服务助手，可以帮你处理问答、检索和资料说明。' }
])
