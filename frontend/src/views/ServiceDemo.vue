<template>
  <div class="service-demo-container">
    ...
    <header class="header">
      <div class="top-bar">
        <div class="top-container">
          <div class="location">服务演示 · 本地环境</div>
          <div class="login-info">
            <span>当前模式：</span>
            <a href="#" class="login">演示浏览</a>
            <a href="#" class="register">查看说明</a>
          </div>
          <div class="top-nav">
            <a href="#" @click="backToMain">知识助手</a>
            <a href="#">最近会话</a>
            <a href="#">常见问题 <span class="badge">8</span></a>
            <a href="#">使用说明</a>
            <a href="#">联系支持</a>
          </div>
        </div>
      ...
      <div class="header-main-container">
        <div class="main-header">
          <div class="logo" @click="backToMain">
            <div class="logo-box">KD</div>
          </div>
          <div class="search-box">
            <input type="text" placeholder="输入产品问题、售后场景或知识点" v-model="searchInput"/>
      ...
      <div class="quick-links">
        <div class="quick-links-container">
          <ul class="links-list">
            ...
            <li><a href="#">质保政策</a></li>
            <li><a href="#">产品安装说明</a></li>
            <li><a href="#">发票问题</a></li>
            <li><a href="#">账号与权限</a></li>
            <li><a href="#">设备报修</a></li>
            <li><a href="#">资料上传</a></li>
            <li><a href="#">常见报错</a></li>
            <li><a href="#">人工支持</a></li>
    ...
    <div class="main-content">
      ...
      <div class="sidebar">
        <ul class="category-list">
          <li><i class="icon">📘</i> 产品资料与规格说明</li>
          <li><i class="icon">🧾</i> 订单与履约问题</li>
          <li><i class="icon">🛠</i> 安装、维修与报修</li>
          <li><i class="icon">🔄</i> 退换货与售后政策</li>
          <li><i class="icon">🖼</i> 图片识别与故障辅助</li>
          <li><i class="icon">📂</i> 文件上传与知识建库</li>
          <li><i class="icon">🧠</i> 图谱检索与问答</li>
          <li><i class="icon">📦</i> 库存、物流与到货</li>
          <li><i class="icon">🔐</i> 账号、权限与安全</li>
          <li><i class="icon">☎</i> 转人工与处理进度</li>
        </ul>
      </div>
          ...
          <div class="product-list">
            <div class="product-card" v-for="(product, index) in recommendedProducts" :key="index">
              ...
              <div class="product-info">
                ...
                <button class="add-to-cart-btn">查看说明</button>
              </div>
            </div>
          </div>
        </div>
    ...
    <footer class="footer">
      ...
      <div class="copyright">
        Copyright © 2026 Knowledge Desk Demo. All Rights Reserved.
      </div>
    </footer>
  </div>
</template>
...
const messages = ref<{ role: 'user' | 'assistant', content: string, isLoading?: boolean, imageUrl?: string }[]>([
  {
    role: 'assistant',
    content: '您好！我是知识服务助手，可以帮您处理问答、检索和文件理解。'
  }
])
...
const recommendedProducts = ref([
  {
    name: '退换货政策说明',
    description: '汇总常见退换货条件、申请入口与处理时效。',
    price: '售后政策',
  ...
  {
    name: '安装与部署指南',
    description: '面向产品、设备与本地环境的初始化安装说明。',
    price: '操作指南',
  ...
  {
    name: '质保与维修流程',
    description: '快速查看保修范围、送修资料和维修节点说明。',
    price: '维修流程',
  ...
  {
    name: '图像问题辅助诊断',
    description: '支持上传图片并结合上下文生成问题分析结果。',
    price: '多模态能力',
...
const hotProducts = ref([
  {
    name: '如何创建知识索引？',
    description: '了解文件上传、索引构建与知识检索的基本流程。',
    price: '知识建库',
  ...
  {
    name: '如何继续上一次对话？',
    description: '查看会话记录、恢复上下文与多轮问答的处理方式。',
    price: '会话管理',
  ...
  {
    name: '什么时候适合联网检索？',
    description: '说明实时搜索与本地知识问答的适用边界。',
    price: '检索策略',
  ...
  {
    name: '如何处理图片故障咨询？',
    description: '示例展示图片上传、识别与答复生成的处理链路。',
    price: '图像问答',
...
const toggleChatPopup = () => {
  ...
  if (showChatPopup.value) {
    ...
    if (conversationId.value === null) {
      conversationId.value = 'service_demo_' + Date.now().toString();
    }
